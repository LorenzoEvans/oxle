...
(defn home-page []
      (fn []
       [:div.flex.flex-column.justify-around.flex-column-m.justify-around-m.b--near-black.bw2.bg-image.vh-100
        [:h1.flex.flex-column.justify-center.w-100.w-90-m.flex-column-m.bw2.avenir.dark-gray.f1.ba.b--near-black.bw1.shadow-3.f2-m.tc.self-center "Maybe Sheeps"]
        [:nav.w-100.items-center.flex.flex-row.justify-around.self-center.mt2.mb2.flex-column-m.justify-between-m.h-100-m
         [:a.h4.grow.avenir.no-underline.near-black.ba.bw2.f3.washed-green.bg-dark-gray.w5.br3.shadow-3.flex.items-center.justify-center {:href "https://github.com/LorenzoEvans"} "Github"]
         [:a.h4.grow.avenir.no-underline.near-black.ba.bw2.f3.washed-green.bg-dark-gray.w5.br3.shadow-3.flex.items-center.justify-center {:href "https://twitter.com/0xLEDev"} "Twitter"]
         [:a.h4.grow.avenir.no-underline.near-black.ba.bw2.f3.washed-green.bg-dark-gray.w5.br3.shadow-3.flex.items-center.justify-center {:href "#/posts"} "Posts"]
         [:a.h4.grow.avenir.no-underline.near-black.ba.bw2.f3.washed-green.bg-dark-gray.w5.br3.shadow-3.flex.items-center.justify-center {:href "http://www.lorenzoevans.me/"} "Portfolio"]]
